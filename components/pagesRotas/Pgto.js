...
export default function Pgto(props){
let [fontsLoaded] = useFonts({
  ...
  return(
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={() => { props.navigation.navigate('Cartao') }}>
        <Text style={styles.buttonText}>CARTÕES</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.button} onPress={() => { props.navigation.navigate('Dinheiro') }}>
        <Text style={styles.buttonText}>DINHEIRO</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.button} onPress={() => { props.navigation.navigate('Pix') }}>
